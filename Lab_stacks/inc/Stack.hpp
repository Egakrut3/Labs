...
int DA_stack_push(struct DA_stack *obj, void const *val);
int DA_stack_top(struct DA_stack const *obj, void *dest);
...
int FL_stack_push(struct FL_stack *obj, void const *val);
int FL_stack_top(struct FL_stack const *obj, void *dest);
